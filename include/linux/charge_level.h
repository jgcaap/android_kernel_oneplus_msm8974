...
#define AC_CHARGE_LEVEL_DEFAULT 1500	// 0 = stock charging logic will apply
#define AC_CHARGE_LEVEL_MIN 0
#define AC_CHARGE_LEVEL_MAX 2100

#define USB_CHARGE_LEVEL_DEFAULT 500	// 0 = stock charging logic will apply
#define USB_CHARGE_LEVEL_MIN 0
#define USB_CHARGE_LEVEL_MAX 900
